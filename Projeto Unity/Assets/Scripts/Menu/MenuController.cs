...
public class MenuController : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        for (int i = 0; i < levelItemsFound.Length; i++)
        {
            ...
            levelItemsFound[i].title.text = ("Fase " + levelId.ToString("F0"));
            ...
            //Remove the locker if this is the level 2 or greather, and was done the previous level
            if (levelId > 1)
                if (SaveGameManager.gameLevels[levelId - 1].star1 == true)
                    levelItemsFound[i].levelLocker.gameObject.SetActive(false);
